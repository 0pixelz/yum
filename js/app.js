...
const POWERUP_ICONS = { extraRoll:'<i class="icn icn-dice"></i>', freezeDie:'<i class="icn icn-gem"></i>', doublePoints:'<svg viewBox="0 0 24 24" width="1em" height="1em" aria-hidden="true" style="display:inline-block;vertical-align:-0.16em"><rect x="3.5" y="3.5" width="17" height="17" rx="4.5" fill="currentColor"/><text x="12" y="12.9" text-anchor="middle" dominant-baseline="central" font-family="Arial,Helvetica,sans-serif" font-weight="800" font-size="11" fill="#141428">×2</text></svg>', luckyDice:'<i class="icn icn-star"></i>', undoMove:'<i class="icn icn-refresh"></i>', chanceRoll:'<i class="icn icn-volcano"></i>', yamOrStrike:'<i class="icn icn-skull"></i>', wildcard:'<i class="icn icn-target"></i>', goldenDice:'<i class="icn icn-dice-stack"></i>', bonus25:'<i class="icn icn-coin"></i>' };
